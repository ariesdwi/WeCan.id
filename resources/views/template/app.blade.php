        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="{{route('front')}}" class="logo"><img src="{{asset('front/img/logo1.png')}}" alt=""></a>
                    </div>
                    <!-- /logo -->
                    ...
                    <ul class="nav-menu nav navbar-nav">
                          @foreach ($categori as $item)
                            <li class="cat-{{$item->id}}"><a href="{{route('artikel.categori' , $item->slug )}}">{{$item->nama_kategori}}</a></li>
                          @endforeach
                    </ul>
